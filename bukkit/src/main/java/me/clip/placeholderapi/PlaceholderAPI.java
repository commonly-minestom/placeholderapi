...
public final class PlaceholderAPI {
    ...
    static final Pattern PLACEHOLDER_PATTERN = PlaceholderPatterns.placeholder();
    static final Pattern BRACKET_PLACEHOLDER_PATTERN = PlaceholderPatterns.bracketPlaceholder();
    static final Pattern RELATIONAL_PLACEHOLDER_PATTERN = PlaceholderPatterns.relationalPlaceholder();

...
import me.clip.placeholderapi.configuration.BukkitYamlConfiguration;
 ...
 */
public final class PlaceholderAPIPlugin extends JavaPlugin implements PlatformPlugin {
    ...
    @Override
    public <S> void reloadConf(S sender) {
        reloadConf((CommandSender) sender);
    }

    @NotNull
    @Override
    public YamlConfiguration getConfiguration() {
        return new BukkitYamlConfiguration(getConfig());
    }
